 ...
 *
 * Note: this filter deliberately does NOT run against /api/v1/payments/webhook
 * (see SecurityConfig) - that endpoint is authenticated by gateway signature,
 * not by JWT, per API_CONTRACT.md §4.5.
 */
@Component
